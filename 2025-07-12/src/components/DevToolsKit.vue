...
<template>
  <div relative of-hidden h-1em text-5xl>
    <div transition-all duration-500 :style="sliderStyle">
      <div flex="~ gap-2">
        ...
        <sup v-click op75 text-base translate-y-2 inline-block>Future</sup>
      </div>
  ...
  <div flex="~ gap-2" mt3>
    <DevToolsModule
      v-click icon="i-ri-box-3-line" name="Bundle" logo="i-logos-vitejs" theme="purple"
    />
    <DevToolsModule
      v-after icon="i-ri-search-2-line" name="Plugins" logo="i-logos-vitejs" theme="purple"
    />
    <DevToolsModule
