...
onMounted(() => {
  ...
  const items = new DataSet([
    ...
    {
      id: id++,
      content: '博客： Flat config 介紹（分為三篇文章）',
      group: 1,
      start: '2022-08-03',
      className: 'px2 rounded-lg! bg-green:20! text-green! border-green:50!',
    },
